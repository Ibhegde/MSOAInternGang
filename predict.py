...
parser = argparse.ArgumentParser(prog="predict.py", description="Prediction python module for Hackathon")
parser.add_argument("--path", action="store", default="/data/", required=True, type=str, help="TEST data folder path")
parser.add_argument(--metadata, action="store", default="TEST_images_metadata.csv", required=True, type=str, help="Test images metadata file path")
